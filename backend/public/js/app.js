 ...
 */
        ...
        function ae(t, e, n, r) {
            if (n) if (s(n)) {
                ...
                var i;
                for (var o in n) {
                    if ("class" === o || "style.scss.sass.css.scss" === o) i = t; else {
        ...
        function Fr(t) {
            return "script" === t.tag || "style.scss.sass.css.scss" === t.tag
        }

        function qr(t) {
            return "style.scss.sass.css.scss" === t.tag || "script" === t.tag && (!t.attrsMap.type || "text/javascript" === t.attrsMap.type)
        }
        ...
        function ki(t, e) {
            var n = (e.warn, vn(t, "style.scss.sass.css.scss"));
            if (n) {
                t.staticStyle = JSON.stringify(Sa(n))
            }
            var r = hn(t, "style.scss.sass.css.scss", !1);
            r && (t.styleBinding = r)
        }
